        ...
        <div className=" bg-gray-700 w-full h-full  md:py-3 md:px-6 lg:py-3 lg:px-6">
           ...
           <div className="px-3 py-2  flex items-center justify-start lg:w-6/12 md:w-6/12">
                <div className="container">
                    ...
                    <br/>
                    <Link to="/contact"><button className="text-yellow-400 border border-yellow-400 hover:text-gray-700 hover:bg-yellow-400 px-2 py-1 duration-75">CONTACT ME</button></Link>
                </div>
