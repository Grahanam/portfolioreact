        ...
        <>
          <div className="px-3 md:py-3 lg:py-9 md:px-6 lg:px-8 h-screen md:h-full lg:h-full bg-gray-700 w-full ">
           ...
           <div className="container w-full flex flex-wrap">
                ...
                <a href='https://grahanam.github.io/faceio/' target="_blank" rel="noreferrer"><div className='h-32 w-32  md:h-36 md:w-36 lg:h-44 lg:w-44 m-4 rounded '>
                          <div className='h-full w-full rounded flex items-center justify-center bg-lime-500 '>
                            <h1 className='absolute font-extrabold text-3xl md:text-4xl lg:text-5xl p-2 text-white'>Faceio</h1>
                            <i className="text-6xl md:text-7xl lg:text-8xl hover:text-yellow-400 duration-75"><FontAwesomeIcon icon={faMaskFace}  className=""/></i>
                          </div>
                          <div className=''></div>
                </div>
                </a>
                <a href='https://grahanam.github.io/facerecognition' target="_blank" rel="noreferrer"><div className='h-32 w-32  md:h-36 md:w-36 lg:h-44 lg:w-44 m-4 rounded '>
                          <div className='h-full w-full rounded flex items-center justify-center bg-lime-500 '>
